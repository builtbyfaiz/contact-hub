...
public class Theme {
    ...
    /// Main Colors
    public static final Color BG_MAIN      = new Color(13, 17, 23);
    ...
    public static final Color ACCENT_BLUE   = new Color(31, 111, 235);
    public static final Color ACCENT_YELLOW = new Color(200, 200, 0);
    public static final Color ACCENT_GRAY   = new Color(33, 38, 45);
